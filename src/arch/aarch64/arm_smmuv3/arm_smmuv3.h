...
#define ARCH_MAJOR_REV_SHIFT UINT32_C(4)
#define ARCH_MAJOR_REV_MASK UINT32_C(0xf)
#define ARCH_MINOR_REV_SHIFT UINT32_C(0)
#define ARCH_MINOR_REV_MASK UINT32_C(0xf)
#define ARCH_MAJOR_VERSION_3 UINT32_C(0)
#define ARCH_MINOR_VERSION_2 UINT32_C(2)
